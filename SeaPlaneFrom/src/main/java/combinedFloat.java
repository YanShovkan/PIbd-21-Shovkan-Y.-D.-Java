...
public class combinedFloat implements IFloatForm {
    ...
    public void draw(Graphics g, int _startPosX, int _startPosY,Color dopColor) {
        ...
        if (floats == EnumerationOfFloats.Two) {
            ...
            g.setColor(dopColor);
            g.fillOval(_startPosX + 10, _startPosY + 55, 70, 10);
        ...
        if (floats == EnumerationOfFloats.Four) {
            ...
            g.setColor(dopColor);
            g.fillOval(_startPosX + 23, _startPosY + 55, 28, 10);
            g.fillRect(_startPosX + 23, _startPosY + 55, 28, 5);
            g.fillOval(_startPosX + 58, _startPosY + 55, 28, 10);
        ...
        if (floats == EnumerationOfFloats.Six) {
            ...
            g.setColor(dopColor);
            g.fillOval(_startPosX + 15, _startPosY + 55, 25, 10);
            g.fillRect(_startPosX + 15, _startPosY + 55, 25, 5);
            g.fillOval(_startPosX + 45, _startPosY + 55, 25, 10);
            g.fillRect(_startPosX + 45, _startPosY + 55, 25, 5);
            g.fillOval(_startPosX + 75, _startPosY + 55, 25, 10);
